...
define install_to
	$(INSTALL) -d -m 0755 $(1)/$(INCLUDEDIR)/amxc
	$(INSTALL) -D -p -m 0644 include/amxc/*.h $(1)$(INCLUDEDIR)/amxc/
	$(INSTALL) -D -p -m 0644 output/$(MACHINE)/$(COMPONENT).a $(1)$(LIBDIR)/$(COMPONENT).a
